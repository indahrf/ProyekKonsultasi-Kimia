...
class profileMahasiswa2Controller extends Controller
{
    function index()
    {
        return view("dashboardMahasiswa.profileMahasiswa.index");
    }
    ...
    function update(Request $request)
    {
        ...
        return redirect()->route('profileMahasiswa.index')->with('success', 'Berhasil update data');
    }
}
