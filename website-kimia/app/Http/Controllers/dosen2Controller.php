...
class dosen2Controller extends Controller
{
    ...
    {
        $user = Auth::user();
        $data = Dosen::where('email', $user->email)->first();
        return view('dashboardDosen.index')->with('data', $data);
    }
    ...
    {
        return view('dashboardDosen.dataDosen.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('dashboardDosen.dataDosen.edit')->with('data', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        $request->validate(
            ...
            [
                ...
                'nip.required' => 'NIP wajib diisi',
                'email.required' => 'Email Prodi wajib diisi',
                'jabatan.required' => 'Bidang keahlian wajib diisi',
        ...
        return redirect()->route('dataDosen.index')->with('success', 'Berhasil mengubah data');
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('dataDosen.index')->with('success', 'Berhasil menghapus data');
