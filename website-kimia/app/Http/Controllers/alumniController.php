...
class alumniController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.alumni.index')->with('data', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('_foto')) {
            ...
            $foto_file->move(public_path('foto/alumni'), $foto_baru);
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.alumni.edit')->with('data', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('_foto')) {
            ...
            $data = mahasiswa::where('id', $id)->first();
            $foto_lama = $data->foto;
            File::delete(public_path('foto/alumni') . "/" . $foto_lama);        
        }else {
            $data = mahasiswa::where('id', $id)->first();
            $foto_baru = $data->foto;
        }
        ...
        return redirect()->route('alumni.index')->with('success', 'Berhasil mengupdate data');
    }
