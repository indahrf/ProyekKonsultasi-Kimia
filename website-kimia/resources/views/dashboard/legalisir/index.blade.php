...
@section('konten')
    <form action="{{ route('legalisir.update') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        @if ($data->foto)
          <img style="max-width:100px;max-height:100px" src="{{ asset('foto/legalisir') . '/' . $data->foto }}">
        @endif
        <div class="mb-3">
