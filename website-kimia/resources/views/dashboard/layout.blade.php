        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('prodi.index')}}">
              <i class="mdi mdi-file-document-box-outline menu-icon"></i>
              <span class="menu-title">Profil Program Studi</span>
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('tenagaKependidikan.index')}}">
              <i class="mdi mdi-file-document-box-outline menu-icon"></i>
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('staff.index')}}">
              <i class="mdi mdi-file-document-box-outline menu-icon"></i>
              <span class="menu-title">Pimpinan dan Koordinator</span>
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('programKimia.index')}}">
              <i class="mdi mdi-file-document-box-outline menu-icon"></i>
              <span class="menu-title">Program Kimia</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{route('kerjaSama.index')}}">
              <i class="mdi mdi-file-document-box-outline menu-icon"></i>
              <span class="menu-title">Program Kerja Sama</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{route('pengabdian.index')}}">
              <i class="mdi mdi-file-document-box-outline menu-icon"></i>
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('jurnal.index')}}">
              <i class="mdi mdi-file-document-box-outline menu-icon"></i>
              <span class="menu-title">Jurnal Prodi Kimia</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{route('profileMahasiswa.index')}}">
              <i class="mdi mdi-file-document-box-outline menu-icon"></i>
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('legalisir.index')}}">
              <i class="mdi mdi-file-document-box-outline menu-icon"></i>
              <span class="menu-title">Informasi Legalisir</span>
            </a>
          </li>
          <li class="nav-item">
