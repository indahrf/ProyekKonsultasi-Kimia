    ...
    <form action="{{route('mahasiswa.update', $data->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <select name="tipe" id="tipe">
              ...
              <option value="Kegiatan dan Prestasi" {{ $data->tipe == "Kegiatan dan Prestasi" ? "selected" : "" }}>Kegiatan dan Prestasi</option>
              <option value="Beasiswa" {{ $data->tipe == "Beasiswa" ? "selected" : "" }}>Beasiswa</option>
            </select>
        </div>
        <div class="mb-3">
        ...
        @if ($data->foto)
          <img style="max-width:100px;max-height:100px" src="{{ asset('foto/mahasiswa') . '/' . $data->foto }}">
        @endif
        <div class="mb-3">
