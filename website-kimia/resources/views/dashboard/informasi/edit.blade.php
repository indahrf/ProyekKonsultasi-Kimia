    ...
    <form action="{{route('informasi.update', $data->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <select name="tipe" id="tipe">
              ...
              <option value="Agenda" {{ $data->tipe == "Agenda" ? "selected" : "" }}>Agenda</option>
              <option value="Berita" {{ $data->tipe == "Berita" ? "selected" : "" }}>Berita</option>
              <option value="Kegiatan" {{ $data->tipe == "Kegiatan" ? "selected" : "" }}>Kegiatan</option>
              <option value="Pengumuman" {{ $data->tipe == "Pengumuman" ? "selected" : "" }}>Pengumuman</option>
              <option value="Sistem Penjaminan Mutu" {{ $data->tipe == "Sistem Penjaminan Mutu" ? "selected" : "" }}>Sistem Penjaminan Mutu</option>
            </select>
        </div>
        <div class="mb-3">
        ...
        @if ($data->foto)
          <img style="max-width:100px;max-height:100px" src="{{ asset('foto/informasi') . '/' . $data->foto }}">
        @endif
        <div class="mb-3">
